...
public class Exp5ResultRelativeError implements ExpRunnable {
    ...
    public final static String BASE_DIR = "/Users/zyz/Documents/AQP/paper/exp/exp16/";

    public final static String ACCURATE_RESULT_PATH = BASE_DIR + "accurate_result_50.csv";

//    public final static String NO_RESULT_PATH = BASE_DIR + "no_result_24_48_1.csv";
    public final static String VERDICT_RESULT_PATH = BASE_DIR + "2verdict_result_50.csv";
...
//    public final static String UPDATE_RESULT_PATH = BASE_DIR + "update_result_24_48_1.csv";

    public final static String COMPARISON_PATH = BASE_DIR + "2relative_error_50.csv";
                    ...
                    */
                    ...
                    for (String _query : updateResult.getHeader()) {
                        if (_query.contains("q") && ("q" + (Integer.valueOf(StringUtils.substringBetween(_query, "q", "_")) - 51) + "_").contains(query + "_")) {
                            ...
                            relativeError = relativeError + Math.abs(updateUnit.r - accurate) / accurate;
                        }
                    }
                    relativeError = relativeError / repeatTime;
                    comparisonResult.push(datetime, query + "_" + "adaptive", String.format("%.4f", relativeError));
